...
const projects = [
  {
    ...
    description:
      "Store E-Commerce is a web application that was developed for a grocery store which sells various basic basket products.",
    image: "/store.jpg",
    github: "https://github.com/Gareth99/Store",
    link: "https://store-rest.netlify.app/",
  },
  {
    name: "OpenBis",
